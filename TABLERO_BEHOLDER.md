...
gantt
  ...
  Desk research + shadowing + entrevistas + cliente incógnito · Alejandro :done, 2026-06-30, 2026-07-04
  Validación con stakeholders · Alejandro, Melissa :done, 2026-07-03, 2026-07-04
  6 sacrificial concepts — validación con Legal, Cumplimiento y clientes · Alejandro :2026-07-06, 2026-07-10
...
| Q-6 | Desk research + bench de estrategias de contacto en frío y caliente + shadowing con asesores, entrevistas y cliente incógnito | Done | Entregado (4 días); corregido — el research incluyó shadowing/entrevistas/cliente incógnito, no solo desk research y bench | Evidencia de qué gatillos abren conversación en frío vs. caliente (reciprocidad, curiosidad, personalización), más observación directa de la conducta real del asesor (shadowing) y del cliente (cliente incógnito) | 30/06/2026 | 03/07/2026 | 0 🪙 | Alejandro | Service Design | — | Insumo para estrategia de contacto |
...
| Q-8 | 6 sacrificial concepts: validación de la estrategia de contacto con Legal, Cumplimiento y clientes | To Do | Programada (4 días); corregido — no eran para elicitar objeciones de no clientes, eran el vehículo de validación con Legal/Cumplimiento/clientes | Conceptos provocadores usados como vehículo de validación temprana con Legal, Cumplimiento y clientes reales — pone a prueba la estrategia de contacto antes de comprometerse con el diseño final | 06/07/2026 | 09/07/2026 | 0 🪙 | Alejandro | Service Design | — | Insumo para estrategia de contacto validada |
...
| Q-68 | Encuesta a asesores sobre herramientas (n=19) | Done | Entregada; ver `research/evidencia_asesores_back_to_basics.md` para el análisis completo | Diagnóstico cuantitativo (frecuencia de uso, satisfacción 0–10) y cualitativo (abiertas) sobre las herramientas del asesor — valida manejo de objeciones como dolor #1 y evidencia problemas de calidad de información en AIDA | — | — | — (no informado) | (por confirmar) | — | — | Respalda directamente Q-64 (AIDA), Q-65 (entrenamiento) y Q-62 (materiales visuales) con evidencia primaria |
| Q-69 | Taller de Manejo de Objeciones (CoE Experience Design) | Done | Entregado; 30/36 asistentes (83.33%). Satisfacción de contenido 99.33%, desempeño del speaker 98.67%, NPS 96.67. Reportado por CoE Experience Design. ⚠️ El uso de "Copilot" como herramienta diferenciadora coincide en 3 puntos con Q-13 (AIDA Skill Trainer: tema, mecanismo role-play+feedback+IA, y el mismo defecto de consistencia de la IA) — evidencia fuerte de que es el mismo piloto o su primera corrida real; confirmar antes de fusionar el registro. Detalle completo en `research/evidencia_asesores_back_to_basics.md` | Práctica basada en casuística real + role-play con IA (Copilot/AIDA) + feedback — mismo mecanismo que Q-13. Oportunidades de mejora reportadas: más diversidad de casos (role play, videos), consistencia del Copilot/AIDA, logística (duración, horarios, espacio de práctica) | — | — | — (no informado) | (por confirmar) | CoE Experience Design | Posible duplicado/solape con Q-13, confirmar; la inconsistencia de Copilot/AIDA es el mismo defecto que ya reporta la encuesta (Q-68) | NPS 96.67 — evidencia fuerte para priorizar Q-64 (AIDA) y Q-65 (entrenamiento) |
