...
**Estado del proyecto:** WIP  ·  **Ciclo/Sprint:** Cierre Q2 2026 (junio–julio)  ·  **Fecha:** 2026-06-22

> ⚠️ **Fichas en propuesta:** el board original no traía capacidad. Los valores de fichas
> son una distribución propuesta por el Beholder según la carga aparente, **pendiente de
> confirmación**. Ajusta los números que no reflejen la realidad.
...
|---|---|---|---|---|
| — | Q-5 · Mensajes primer contacto 🚩 | Q-1 · Guías 4 prod. AMI | Q-8 · Skill AIDA Bot Trainer 🚩 | Q-3 · Guías 5 TOP EPS |
| | | Q-2 · Batería renovación AMI | | Q-10 · Bienestar 360 |
| | | Q-4 · Evolution+ Cobranzas 🚩 | | |
| | | Q-6 · Loyalty | | |
| | | Q-7 · Universidad Vida | | |
| | | Q-9 · Kit Social Selling 🚩 | | |

## 📋 Épicas y quests (detalle)

### EPIC-1 · Back to Basics FFVV Vida Individual
Fortalecer la fuerza de ventas de Vida Individual: agendamiento, formación y generación de leads.
...
| Q-8 | Skill AIDA Bot Trainer + reportería | In Review | 6 🎟️ | Felipe, Melissa | AIDA no cumple el task; entra a comité de priorización; 3 herramientas en paralelo 🚩 | Sube la efectividad del asesor —medible con el propio puntaje del bot— y la consistencia en atención; la práctica deliberada con feedback acelera la curva de competencia (benchmark −25–40% de ramp, est.). Las alertas dan a jefaturas coaching dirigido. Ahorro proyectado S/1.8M (cifra del board; conviene documentar su base de cálculo) |
...
> **Descripción · Q-8 (Skill AIDA Bot Trainer):** agente con el que el asesor practica casos reales; genera un **puntaje de efectividad** por asesor y emite **alertas cuando faltan principios básicos de experiencia (CX)**, visibles a las **jefaturas FFVV** para coaching dirigido.
...
| Clave | Quest | Estado | Fichas | Behavioral designers | Riesgos | Impacto |
|---|---|---|---|---|---|---|
| Q-4 | Captura de datos para conciliación | In Progress (research) | 4 🎟️ | Stef | Track de diseño aprobado sin exploración de la problemática 🚩 | Liberación de S/600k provisionados |
...
| Clave | Quest | Estado | Fichas | Behavioral designers | Riesgos | Impacto |
|---|---|---|---|---|---|---|
| Q-10 | Bienestar 360 | Done (Mantenimiento) | — | — (lo operan Equipo Bienestar / Estar Bien) | Presupuesto y recursos limitados para la siguiente versión | +3 ptos Wellby · CSAT 4.6/5 · NPS 78 |
...
|---|---|---|---|---|
| Stef | 8 | 2 | 🟢 Óptimo | Q-1: 3, Q-3: 1, Q-4: 4 |
| Felipe | 8 | 2 | 🟢 Óptimo | Q-1: 3, Q-3: 1, Q-8: 4 |
| Alejandro | 9 | 1 | 🔴 Sobreasignado | Q-1: 2, Q-2: 2, Q-3: 1, Q-5: 1, Q-6: 2, Q-7: 1 |
| Melissa | 8 | 2 | 🟢 Óptimo | Q-7: 3, Q-8: 2, Q-9: 3 |

**Alertas de capacidad:** (solo sobreasignados/inválidos; la holgura no genera alerta)
- 🔴 **Alejandro: 9 comprometidas.** Está usando 1 ficha de su reserva → le queda solo la mitad del aire para overhead (correos, contexto, coordinación con stakeholders de AMI, FFVV y Loyalty al mismo tiempo). **Ajuste sugerido:** como **Q-5 (Mensajes de primer contacto) está en Block** sin estrategia definida, retira su 1 ficha de Q-5 hasta que se desbloquee → vuelve a **8 🟢 Óptimo** sin perder trabajo activo.

## 🚩 Registro de riesgos
| Clave | Quest | Riesgo | Severidad | Mitigación sugerida |
|---|---|---|---|---|
| Q-5 | Mensajes de primer contacto | No hay estrategia definida de contacto bajo contexto CUA (bloqueado) | Alta | Cerrar definición de estrategia con Diana Riofrío / Jaime Huerta antes de reactivar; mantener fichas fuera hasta desbloquear |
| Q-8 | Skill AIDA Bot Trainer | AIDA no cumple el task; comité de priorización; 3 herramientas en paralelo | Alta | Consolidar a 1 herramienta antes del comité; llevar evidencia de usabilidad validada y ahorro S/1.8M |
| Q-9 | Kit de Social Selling | Recursos limitados de contenido + falta de incentivos + falta de monitoreo | Alta | Definir mínimo de incentivos y tablero de monitoreo antes de escalar |
| Q-4 | Evolution+ Cobranzas | Track de diseño aprobado sin explorar la problemática | Alta | Insertar fase corta de research antes de comprometer diseño; S/600k en juego |
| Q-1 | Guías 4 productos AMI | Cambio en el roadmap (de 1 guía a 4 productos) | Media | Re-priorizar entregables y fechas con Estrella Damian / Soiky Bardales |
| Q-2 | Batería renovación AMI | La carta sola no cubre la necesidad del usuario | Media | Desbloquear las 3 soluciones on hold; medir efecto de la carta aislada |
| Q-3 | Guías 5 TOP EPS | Producto pide no comunicar servicios valorados por el usuario | Media | Acordar con Producto un mínimo informativo que no rompa expectativas |
| Q-7 | Universidad Vida | Capacidad limitada del equipo de learning | Media | Acotar alcance del MVP de formación; secuenciar con equipo learning |
| Q-10 | Bienestar 360 | Presupuesto y recursos limitados para la siguiente versión | Media | Asegurar sponsor/budget antes de comprometer v2 |
| Q-6 | Loyalty | — | Baja | — |

## 📈 Impacto
| Clave | Quest | Impacto esperado |
|---|---|---|
| Q-8 | Skill AIDA Bot Trainer | +efectividad del asesor (medible vía el puntaje del bot) y consistencia CX; práctica con feedback acelera ramp (−25–40%, est.); jefaturas hacen coaching dirigido. Ahorro proyectado S/1.8M (cifra del board, base por documentar) |
