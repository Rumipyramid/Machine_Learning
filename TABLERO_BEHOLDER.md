...
|---|---|---|---|---|---|---|
| Q-5 | Mensajes de primer contacto | In Progress | 1 🎟️ | Alejandro | Estrategia CUA en definición (antes bloqueado) | +20–30% agendamiento de citas (est.) |
| Q-7 | Universidad Vida | Diseñado | 4 🎟️ | Melissa, Alejandro | Capacidad limitada equipo learning | −25–40% ramp-up asesores jr (est.) |
| Q-8 | Copiloto del Asesor: AIDA — Bot trainer + reportería | In Review | 6 🎟️ | Felipe, Melissa | AIDA no cumple el task; comité de priorización; 3 herramientas en paralelo 🚩 | +efectividad (puntaje del bot) y CX; ramp −25–40% (est.). Ahorro proyectado S/1.8M |
| Q-9 | Kit de Social Selling | In Progress | 3 🎟️ | Melissa | Recursos de contenido + falta incentivos/monitoreo 🚩 | +leads/agendamientos; 15–25% conversión lead→cita (est.) |
...
| Clave | Quest | Estado | Fichas | Behavioral designers | Riesgos | Impacto |
|---|---|---|---|---|---|---|
| Q-6 | Programa de lealtad — Piloto/MVP | In Progress | 2 🎟️ | Meli, Alejandro | — | Permanencia base RIMAC; +20–25% retención (est.) |
| Q-19 | Comunicaciones Loyalty (piezas y journeys) | In Progress | — | (por confirmar) | — | — |
| Q-20 | Modelo de relacionamiento empresas + Propuesta de valor | In Progress | — | (por confirmar) | — | — |
...
| Clave | Quest | Estado | Fichas | Behavioral designers | Riesgos | Impacto |
|---|---|---|---|---|---|---|
| Q-10 | Bienestar 360 | Done | 3 🎟️ | Stef | Presupuesto limitado para v2 | +3 ptos Wellby · CSAT 4.6/5 · NPS 78 |
| Q-16 | MBI – Vivo (piloto) | In Progress | — | (por confirmar) | — | — |
...
| Clave | Quest | Estado | Fichas | Behavioral designers | Riesgos | Impacto |
|---|---|---|---|---|---|---|
| Q-15 | Nuevos planes AMI + Seguro PT/P | In Progress | — | (por confirmar) | — | — |
...
| Clave | Quest | Estado | Fichas | Behavioral designers | Riesgos | Impacto |
|---|---|---|---|---|---|---|
| Q-11 | Modelo de entendimiento y uso eficiente de seguros | In Progress | — | Todos | — | Framework de entendimiento y uso eficiente de seguros |
| Q-12 | Sistema de generación de usuarios sintéticos | Diseñado | — | Todos | — | Agilidad en el testeo de conducta con seguros |
| Q-13 | Modelo de cambio de hábitos | Done | — | Todos | — | Framework para iniciativas de cambio de hábitos |
| Q-14 | Skill para desk research con rigurosidad científica | Diseñado | — | Todos | — | Agilidad y calidad de la investigación de escritorio |

### EPIC-9 · Renovación (nuevas) · Backlog
| Clave | Quest | Estado | Fichas | Behavioral designers | Riesgos | Impacto |
|---|---|---|---|---|---|---|
| Q-21 | RIMAC Wrap (tangibilización pre-renovación) | Backlog | — | (por confirmar) | — | — |
| Q-22 | Recordatorio multicanal (SMS/WhatsApp/Push) | Backlog | — | (por confirmar) | — | — |

### EPIC-10 · Venta / Modelos nuevos · Backlog
| Clave | Quest | Estado | Fichas | Behavioral designers | Riesgos | Impacto |
|---|---|---|---|---|---|---|
| Q-23 | Sistema de incentivos orientados a la experiencia | Backlog | — | (por confirmar) | — | — |
| Q-24 | Convenios y Financieros — nuevo modelo de venta | Backlog | — | (por confirmar) | Sponsors: Diana Riofrío, Patricia Romero, Claro Gomez | — |
| Q-25 | Vida Individual — Experiencia Postventa | Backlog | — | (por confirmar) | Sponsor: Diana Riofrío | — |
| Q-26 | Ahorro Salud — Derivación eficiente MER | Backlog | — | (por confirmar) | — | — |
...
| — | Capacidad del equipo | Alejandro 🔴 (9) + iniciativas nuevas sin fichas | Media | Re-asignar fichas antes de comprometer el Backlog Q3 |
