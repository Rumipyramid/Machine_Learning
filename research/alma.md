...
| `_outputs/aida-copiloto-presentacion-mauricio-2026-09-09.html` — deck HTML 16:9 on-brand (skill `rimac-slides`, 26 slides) del diagnóstico de AIDA en la venta de Vida, para la decisión de Mauricio (VP de Canales): POC externo vs. evolucionar AIDA. Carátula y transiciones con fondo de un solo color, listas para foto a sangre | — (contenido provisto: diagnóstico AIDA ya validado — encuesta 19 asesores, auditoría 46 preguntas, 4 entrevistas, logs 3.606 consultas, dashboard 242.785 consultas) | 2026-09-09 | al día |
