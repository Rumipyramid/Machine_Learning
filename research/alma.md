...
| `_nodes/tamizaje-cervical-asc-us-peru.md` | Tamizaje cervical y manejo de ASC-US (Mundo vs. Perú): qué es la categoría gris y su diagnóstico diferencial no-VPH, umbral de riesgo de ASCCP, triaje por VPH, divergencia con la norma peruana (Directiva 165-MINSA/DGIESP-2025), el daño real (escisión, no biopsia) y la economía del procedimiento. **§11 cubre el escenario con hallazgo clínico**, donde las conclusiones de tamizaje se invierten | 2026-08-14 | **v2.0** (cambio de alcance: de *tamizaje asintomático* a *tamizaje + evaluación de hallazgo clínico*. §0.1 introduce la bifurcación que gobierna todo el node — con cuello friable o sangrado de contacto, la colposcopía+biopsia está indicada **sin esperar el VPH** y la aritmética de riesgo del ASC-US no aplica; §11 desarrolla el principio (F-501), las cifras contra el alarmismo (F-503: 97,7% sin patología, VPP de cáncer 1,70%), la cervicitis como explicación unificadora y el hueco del NAAT clamidia/gonorrea (F-504), y la desambiguación biopsia cervical vs. endometrial (F-505)) |
