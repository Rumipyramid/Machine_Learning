...
*Mapa maestro de los documentos de conocimiento del proyecto. Última actualización: 2026-09-03.*
...
| `_nodes/mecanismos-seguros-salud.md` | Mecanismos de seguros de salud **y eficiencia del gasto**: presión demográfica/costo, balance financiero/rentabilidad global, modelos que la navegan, **qué reduce de verdad el gasto médico (intervenciones no médicas medidas con RCT + palancas clínicas de costo-eficiencia) y matriz de modelos de negocio por rentabilidad × mejora de salud** | 2026-09-03 | **v2.2** — ⚠️ **alcance ampliado** (ver §0 del node): §6 intervenciones no médicas/cambio de hábitos (el ahorro se evapora al aleatorizar), §7 costo-eficiencia clínica ordenada por magnitud (reference pricing −34%, biosimilares, sitio de atención, pago por episodio −3,1%, ACOs ~1-2%), §8 matriz rentabilidad verificada × salud demostrada (Kaiser, Narayana, Aravind, PBM/Optum, Medicare Advantage/MedPAC, Discovery, Oak Street/CVS, Hapvida, Ping An), §9 seis reglas — incl. el *problema del bolsillo equivocado*; **§10 (v2.1)** cuidado integral, modelo de Porter/VBHC y autoatención digital — separa *programa añadido* (sin retorno) de *rediseño con cambio de riesgo* (con retorno), y ordena el arsenal del asegurador por efecto sobre siniestralidad (red limitada, reference pricing, autorización previa y su daño); reglas 7-9; **§11 (v2.2)** glosario operativo de todas las estrategias con impacto en salud, impacto en negocio y nivel de evidencia. F-469 a F-521 |
