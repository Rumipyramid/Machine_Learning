...
*Mapa maestro de los documentos de conocimiento del proyecto. Última actualización: 2026-08-09.*
...
| `_nodes/tendencias-diseno-innovacion.md` | **Node acumulativo** — Tendencias en **diseño e innovación**: qué tiene impacto tangible demostrado y qué es propuesta sin respaldo. 🎨 Diseño (producto/UX, IA, design systems, servicio, visual) + 💡 innovación (gestión de la innovación, innovation labs, difusión, ROI, insurtech). ⚠️ **Alcance ampliado y node renombrado el 2026-08-02** (antes `tendencias-diseno.md`; ver §0). Escala de madurez de evidencia, tablero de **34 hipótesis vivas**, **24 reglas de criterio** destiladas y bitácora de iteraciones | 2026-08-09 | **v5.0 (iteración 5)** — ⚖️ **el plazo vencido y el grupo de control**. **H13, la única hipótesis con fecha, venció y se resolvió a medias**: Figma creció **48%** (umbral 40%), batió EPS 2×, subió la guía anual US$40M — y la acción quedó en **US$23,29**, por debajo de donde estaba y lejos de $33 (F-469, F-470). **Las dos condiciones se cumplieron; la inferencia no sobrevivió al control**: esa misma semana Datadog batió todo, subió guía y tuvo **la mayor caída diaria de su historia**, con Duolingo, AppLovin y Western Digital castigados igual y los índices planos (F-471, F-472) — lo cotizado era *software de múltiplo alto desacelerando*, no disrupción del diseño → regla **C23**. ⬇️ **H16 recibe su primer contraejemplo limpio**: Figma reportó NDR **136%**, que es una *caída* desde 139%, más ambos tramos de paid customers y divulgación **nueva**. 🔄 **H29 reformulada**: Lemonade mejoró justo la variable que la hipótesis señalaba (gross loss ratio 88%→**59-60%**, LAE **5%** récord) **y perdió US$43M igual** porque compra crecimiento; Root sostuvo CR **92,1%** y ganó US$25M **con crecimiento cero**; el mercado castigó **los dos polos** → **H34**. ⭐⭐⭐ **La corrección más estructural: H31 `respaldada` y corrige a H20/H21/H25/C18** — el INE español (**27,3%**, microdato abierto) y el INEI/PRODUCE peruano (Encuesta Nacional de Innovación desde 2012, **microdato en el mismo catálogo ANDA del que el proyecto ya toma ENAHO**) demuestran que el dato local en español **sí existe**; lo que no existe en ningún idioma ni país es el instrumento equivalente **para diseño**. **La ausencia era disciplinar, no geográfica** → **H32**, con su matiz metodológico (F-478) → **C24**. 🪞 **H24 ampliada**: lo que casi entra sin auditar no fue un hallazgo reconciliador sino **autoconfirmatorio** — la condición de riesgo no es reconciliar, es *convenir*. 3 hipótesis nuevas (H32-H34), 2 reglas nuevas (C23-C24). F-469 a F-481. · *v4.0 (iteración 4)* — 💡 **apertura del dominio de innovación y prueba de transferencia de la tesis**: el vínculo I+D→desempeño es real, pequeño y mediado igual que diseño→desempeño (F-430); 4 cadenas de eco nuevas con la misma anatomía; y un defecto **peor** que el eco — el **huérfano de cita** (F-444: las cifras de fracaso del dominio no colapsan en *ninguna* fuente) → regla **C22**. ⭐ Con dos puntos donde innovación **supera** a diseño: se autocorrige sola (F-431/F-432 desmienten el mito del "80-95% de productos que fracasan" con 83.719 SKU reales) y aporta **el único RCT preregistrado de todo el node, y es de seguros** (F-442, UBI/telemática, N=1.449). La crisis del modelo se replica pero **le ocurre a otro eslabón**: muere la función interna (labs, CVC), sobrevive el proveedor externo fusionándose (H28). 5 hipótesis nuevas (H27-H31). F-430 a F-468. · *v3.0 (iteración 3)* — **la iteración en que el node se auditó a sí mismo**: el *impuesto de verificación* que la iter. 2 celebró **no tiene fuente primaria rastreable** (6.ª cadena de eco, y la primera propia) → **H19 degradada**; **H20 `respaldada`** con 13/13 (100%) de cifras hispanohablantes de emisores anglosajones interesados, tres atribuidas a un Gartner que nunca las publicó; **H5, H10, H11, H15 → `parcial`**; **H22 reformulada** (la industria no rota cifras, las acumula); desmentido oficial de MercadoLibre vuelve contestado el caso testigo de la iter. 2. 4 hipótesis nuevas (H23-H26), 3 reglas nuevas (C19-C21), 2 corregidas (C16, C17). F-399 a F-429 |
