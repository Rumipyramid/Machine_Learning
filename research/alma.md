...
| `_outputs/validacion-estrategia-canales-digitales-lowfi-2026-09-11.html` — borrador low-fi (B/N) con las siete decisiones de la estrategia de canales digitales, para validación de los service designers (César, Jonathan) antes de la sesión del 14-sep | deriva de `_outputs/estrategia-canales-digitales-rimac-plan-2026-09-11.md` | 2026-09-11 | al día |
