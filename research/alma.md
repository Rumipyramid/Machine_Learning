...
| `_nodes/matriz-productos-vida-rimac.md` | Matriz de productos Vida RIMAC: catálogo de 6 productos finales (Plan Vida Flexible, Vida Contigo, Vida Temporal Total, Vida Ahorro Garantizado, VCD digital, Endosable digital — VFP descontinuado), coberturas/addons, trazabilidad de fuentes y niveles de confianza | 2026-07-26 | v1.1 |
