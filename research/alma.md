...
*Mapa maestro de los documentos de conocimiento del proyecto. Última actualización: 2026-09-10.*
...
| `_nodes/confianza-asesor-compra-seguro-vida.md` | Confianza en el asesor como factor de compra de seguro de vida y las dimensiones/antecedentes que la componen (empírico + teórico/crítico) — modelo ABI (Mayer-Davis-Schoorman), procesos cognitivos de Doney-Cannon, jerarquías dimensionales de servicios financieros, capa sociológica (Luhmann, Giddens), esquema de correlación en texto y contraevidencia buscada a propósito | 2026-09-10 | v1.0 |
