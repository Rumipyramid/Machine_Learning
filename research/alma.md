...
*Mapa maestro de los documentos de conocimiento del proyecto. Última actualización: 2026-09-09.*
...
| `_nodes/curva-aprendizaje-herramientas-digitales-venta.md` | Curva de aprendizaje de asesores comerciales con herramientas digitales de venta (parámetros de producto, guiones, técnicas de venta): power law vs. exponential law de práctica, Kirkpatrick/Phillips y sus críticas, práctica deliberada (Ericsson vs. Macnamara), time to proficiency/onboarding comercial, adopción de sales enablement tools — sustento para diseñar indicadores de un prototipo tipo AIDA | 2026-09-09 | v1.0 |
