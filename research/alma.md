...
| `_outputs/release-1-base-conocimiento-aida.md` — **Release 1 de la base de conocimiento de AIDA (Vida)**: alcance ejecutable en 5 entregables (resolver el catálogo · sacar del índice lo que no debe responder · cargar el cuerpo canónico derivado · reescribir los cuadros más consultados · banco de control con medición del antes), inventario como entregable cero, qué va a fases siguientes, el riesgo de adopción que puede anularlo entero, y lo que no arregla. Integra el research de Felipe con el diagnóstico | `diagnostico-copiloto-ai-asesor-vida-rimac` (v1.9), `arquitectura-conocimiento-agentes-copilot` (v1.2), `matriz-productos-vida-rimac`, Playbook y research de Felipe en `_fuentes_internas/` | 2026-08-14 | al día |
