...
| `_nodes/tendencias-diseno.md` | **Node acumulativo** — Tendencias en diseño: qué tiene impacto tangible demostrado y qué es propuesta innovadora sin respaldo (producto/UX, IA, design systems, servicio, visual). Incluye escala de madurez de evidencia, tablero de **23 hipótesis vivas** y **24 reglas de criterio** destiladas. **Iter. 2 añade:** §1.bis con **correcciones de hecho a la iteración anterior** (mecanismo permanente), barrido en español/portugués, tradición latinoamericana del diseño, y la resolución de H6 vía la literatura de *software reuse* | 2026-07-27 | v1.1 (iteración 2) |
