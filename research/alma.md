...
| `_nodes/tendencias-diseno.md` | **Node acumulativo** — Tendencias en diseño: qué tiene impacto tangible demostrado y qué es propuesta innovadora sin respaldo (producto/UX, IA, design systems, servicio, visual). Escala de madurez de evidencia, tablero de **22 hipótesis vivas**, **18 reglas de criterio** destiladas y bitácora de iteraciones | 2026-07-29 | **v2.0 (iteración 2)** — confrontación de las 5 hipótesis heredadas: **H17 refutada** (no hay desfase geográfico en LatAm), **H3 y H18 → `parcial`**, 5.ª cadena de eco de cita en el ROI de design systems, divergencia ⚔️ de productividad con IA reconciliada por el *impuesto de verificación*. F-380 a F-398 |
