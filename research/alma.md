...
| `_nodes/tendencias-diseno-innovacion.md` | **Node acumulativo** — Tendencias en **diseño e innovación**: qué tiene impacto tangible demostrado y qué es propuesta sin respaldo. 🎨 Diseño (producto/UX, IA, design systems, servicio, visual) + 💡 innovación (gestión de la innovación, innovation labs, difusión, ROI, insurtech). ⚠️ **Alcance ampliado y node renombrado el 2026-08-02** (antes `tendencias-diseno.md`; ver §0). Escala de madurez de evidencia, tablero de **31 hipótesis vivas**, **24 reglas de criterio** destiladas y bitácora de iteraciones | 2026-08-21 | **v5.0 (iteración 5)** — **vencen las apuestas fechadas y el aparato predice**: ⭐ **H13 `respaldada`** (Figma creció 48% en Q2 2026 y la acción cayó a ~$24-27 como se predijo, por costo de IA + desaceleración — F-469); ⭐ **H29 `respaldada` y ampliada** (Root CR 92,1% vs. Lemonade en pérdida creciendo 79%: la condición, no la tecnología, los separa — y **el mercado castiga a las dos** → regla **C23**, F-470/F-471); ⭐ **H24 `respaldada`** — la auditoría hacia adentro (C20) del RCT de UBI (F-442) lo corrige: financiador limpio pero programa **simulado** y efecto **confundido con incentivo de $100** (F-472) → regla **C24**; **H31 `parcial`** (el corpus de innovación **sí generó estudio propio** — Technovation 2024 con autor de la Javeriana — rompiendo la simetría con diseño, F-474); **H14 afilada** (ronda de Lovable cerró a $13,3B; churn oculto); **H16 refutada en Figma**. 2 reglas nuevas (C23, C24). F-469 a F-475. · *v4.0 (iteración 4)* — 💡 **apertura del dominio de innovación y prueba de transferencia de la tesis**: el vínculo I+D→desempeño es real, pequeño y mediado igual que diseño→desempeño (F-430); 4 cadenas de eco nuevas; el **huérfano de cita** (F-444) → regla **C22**; innovación se autocorrige donde diseño no (F-431/F-432, mito del "80-95%" con 83.719 SKU reales) y aporta el único RCT del node (F-442). 5 hipótesis nuevas (H27-H31). F-430 a F-468. · *v3.0 (iteración 3)* — **la iteración en que el node se auditó a sí mismo**: el *impuesto de verificación* que la iter. 2 celebró **no tiene fuente primaria rastreable** (6.ª cadena de eco, y la primera propia) → **H19 degradada**; **H20 `respaldada`** con 13/13 (100%) de cifras hispanohablantes de emisores anglosajones interesados, tres atribuidas a un Gartner que nunca las publicó; **H5, H10, H11, H15 → `parcial`**; **H22 reformulada** (la industria no rota cifras, las acumula); desmentido oficial de MercadoLibre vuelve contestado el caso testigo de la iter. 2. 4 hipótesis nuevas (H23-H26), 3 reglas nuevas (C19-C21), 2 corregidas (C16, C17). F-399 a F-429 |
