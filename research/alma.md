...
| `_outputs/brief-arquitectura-agente-2026-08-12.html` + `Brief-arquitectura-agente-IA.pdf` — **brief para Arquitectura de Capacidad (CIA)**: 35 recomendaciones en 9 capas, cada una marcada según venga de la evaluación del asesor web (8), de la literatura (19) o de ambas (8) | `capacidades-asistente-ia-aseguradora` | 2026-08-12 | al día |
