...
| `_nodes/copiloto-ia-fuerza-de-ventas.md` | ¿Un copiloto de IA potencia a la fuerza de ventas? Evidencia de 360° (empírica + social + negocio). Sí, con respaldo causal 🟢A — pero de una **configuración específica**: IA + coach humano ensamblados, feedback restringido, segmentado por nivel del vendedor, con la frontera de uso delimitada, y **detrás del asesor, nunca declarado frente al cliente**. ⚔️ Documenta que **cuando la evidencia sube de rigor el efecto baja de magnitud** (+26/+35% de vendors sin control vs. +7/+14% con asignación aleatoria, y casos de efecto cero y negativo). §5 traduce todo a seis implicaciones para AIDA/Espacio Digital del Asesor | 2026-08-14 | v1.0 |
