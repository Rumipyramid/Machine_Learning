...
*Mapa maestro de los documentos de conocimiento del proyecto. Última actualización: 2026-08-14.*
...
| `_outputs/release-1-aida-presentable-2026-08-14.html` — **versión presentable del Release 1** (publicada como artifact compartible): el mismo alcance en lenguaje llano, sin IDs de fuente ni aparato metodológico, pensada para leerse en una reunión con Producto, TI o dirección de canal. La versión extendida en `.md` sigue siendo la fuente de verdad | deriva de `_outputs/release-1-base-conocimiento-aida.md` | 2026-08-14 | al día |
| `_outputs/release-1-base-conocimiento-aida.md` — **Release 1 de las intervenciones en AIDA (Vida)**, v2.0 **en tres etapas** (diagnóstico con asesores + evaluación asistida por LLM · intervención en la base · testeo contra línea base o A/B): alcance ejecutable en 5 entregables (resolver el catálogo · sacar del índice lo que no debe responder · cargar el cuerpo canónico derivado · reescribir los cuadros más consultados · banco de control con medición del antes), inventario como entregable cero, qué va a fases siguientes, el riesgo de adopción que puede anularlo entero, y lo que no arregla. Integra el research de Felipe con el diagnóstico | `diagnostico-copiloto-ai-asesor-vida-rimac` (v1.9), `arquitectura-conocimiento-agentes-copilot` (v1.2), `matriz-productos-vida-rimac`, Playbook y research de Felipe en `_fuentes_internas/` | 2026-08-14 | al día |
