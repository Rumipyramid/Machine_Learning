...
| `_outputs/back-to-basics-speech-3min-2026-08-13.html` — deck HTML 16:9 on-brand (`rimac-slides`) de apoyo para speech oral de 3 min: origen del frente Back to Basics, el taller como evidencia (NPS 96.67, 99.33% satisfacción, 83.33% asistencia), qué se construyó (modelo de venta + 5 componentes de soporte), apuesta central (centralizar copiloto en AIDA) y plan piloto | `proyecto-back-to-basics-ffvv-vida` | 2026-08-13 | al día |
| `_outputs/plan-piloto-reunion-comercial-2026-08-27.html` — deck HTML 16:9 on-brand (`rimac-slides`) para la reunión comercial del piloto: diseño de comparación (playbook pasivo en AIDA para todos vs. capacitación diferencial del grupo piloto), indicadores cualitativos ya definidos (adopción, aplicación real, usabilidad) e indicadores comerciales por cerrar hoy con negocio (tablero de alcance Dentro/A evaluar/Fuera) | `proyecto-back-to-basics-ffvv-vida` | 2026-08-27 | al día |
