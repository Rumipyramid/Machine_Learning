...
| `_nodes/tratamiento-tlp-borderline.md` | Tratamiento del TLP (borderline): qué se sabe sobre "curarlo" — remisión vs. recuperación funcional, la no-superioridad de ninguna escuela de psicoterapia, ausencia de fármaco aprobado, el giro dimensional de la CIE-11 y el estigma como factor iatrogénico (empírico + social + negocio) | 2026-09-10 | v1.0 |
