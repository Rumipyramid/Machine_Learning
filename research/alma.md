...
| `_outputs/estrategia-diagnostico-aida-2026-08-14.html` — **estrategia consolidada de diagnóstico de AIDA** (v2.0, publicada también como artifact compartible): objeto y alcance, los **4 niveles de confianza de la evidencia** (verificado / declarado / deducido / hipótesis), la **cadena causal de 5 eslabones a falsar** con su prueba cada uno, la **taxonomía de 4 capas de falla** incl. la capa D · Ruteo, los 4 frentes con estado, la secuencia en 4 fases con compuertas, **§08 el diseño de validación de los fixes** (dos experimentos, no uno; estratificación por antigüedad obligatoria; escalonado con su controversia declarada), y los riesgos de la propia estrategia | `diagnostico-copiloto-ai-asesor-vida-rimac` (v1.5), `arquitectura-conocimiento-agentes-copilot` (v1.1), `evaluacion-calidad-agentes-conversacionales-ia` (v1.1), `matriz-productos-vida-rimac`, `proyecto-back-to-basics-ffvv-vida` (v1.6) | 2026-08-14 | al día |
