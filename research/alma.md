...
| `_outputs/aida-presentacion-mauricio-figma-slides-2026-09-09.md` — deck ejecutivo "AIDA: el copiloto que el piloto no puede soltar" para el VP de Canales, en formato importable a Figma Slides (30 láminas, tablas convertidas a bloques, dirección de arte en comentarios) | `proyecto-back-to-basics-ffvv-vida` | 2026-09-09 | al día |
