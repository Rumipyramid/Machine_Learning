...
*Mapa maestro de los documentos de conocimiento del proyecto. Última actualización: 2026-08-03.*
...
| `_nodes/embajador-digital-evidencia-academica.md` | Respaldo académico para programa de capacitación "Embajador Digital" (RIMAC Vida/ABC Seguros): social selling, escucha social, source credibility, referidos y adaptación de mensaje por canal — bloques Contenido/Relacionamiento/Activación comercial, con contraevidencia de clientes B2B molestos por social selling sin personalizar (Ancillai et al. 2024) y vacíos de evidencia explícitos (pilares 70/30-80/20 y conversión conversación→cita, sin estudio). ⚠️ Fuentes verificadas por triangulación de búsqueda, no lectura de texto completo (WebFetch 403 en todos los dominios probados) | 2026-08-03 | v1.0 |
