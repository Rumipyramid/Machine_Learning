...
| `_nodes/aida-copiloto-asesor-rimac.md` | **AIDA — el copiloto de IA de la fuerza de ventas de RIMAC** (fuente de verdad del tema; antes vivía disperso en `proyecto-back-to-basics-ffvv-vida`). Consolida encuesta (n=19), **análisis auditado de 2.697 consultas de 274 asesores** y el plan de exploratorio cualitativo. Aporta tres cruces nuevos: con la literatura de copilotos de venta (U invertida de Luo et al. — el remedio al abandono es dar *menos* feedback), con la matriz de productos Vida (⭐ **el mismo hueco de VAG detectado por dos métodos independientes**) y con el brief de arquitectura del agente de clientes (mismo modo de falla). Fuentes F-537 a F-541 | 2026-08-12 | v1.0 |
| `_nodes/capacidades-asistente-ia-aseguradora.md` | **Qué capacidades debe tener un asistente de IA in-app de una aseguradora multi-ramo** (360° con `/trinidad`): frontera de conocimiento, razonamiento numérico como herramienta, escalamiento por culpa/emoción, proactividad como mecanismo de MAU, y el techo legal de *Moffatt v. Air Canada*. Contrasta la propuesta del CoE y califica la fuerza de evidencia de los tres objetivos (autoatención 🔵 / MAU 🟠 / cross-sell 🔴). Fuentes F-511 a F-525 | 2026-08-12 | v1.0 |
...
| `_nodes/metodologias-diseno-sistemas-complejos.md` | Metodologías de diseño para sistemas complejos: complicado vs. complejo, evidencia real de efectividad (SSM, Cynefin, service design, VSM, Vanguard, Wardley), crítica desde dentro del gremio y criterio de selección por problema | 2026-08-05 | v1.0 |
...
| `_outputs/arquitectura-research-ops-2026-08-05.md` — descripción estructural del sistema de research ops (capas y capacidades) para audiencia externa; sin nombres de herramientas | *(transversal — describe el sistema, no un tema de investigación)* | 2026-08-05 | al día |
| `_outputs/revision-modelo-trabajo-diseno-2026-08-10.md` — revisión del modelo de trabajo del equipo de diseño (sesión de construcción metodológica) contrastado contra la evidencia acumulada. Documento **comunicable al propio equipo**: riesgos · oportunidades · sugerencias | `tendencias-diseno-innovacion`, `metodologias-diseno-sistemas-complejos` | 2026-08-10 | al día |
| `_outputs/agente-salud-capacidades-2026-08-12.html` + `Frontera-del-agente-de-salud.pdf` — las 10 capacidades del asistente de IA de salud en tres familias, con nivel de evidencia por capacidad | `capacidades-asistente-ia-aseguradora` | 2026-08-12 | al día |
| `_outputs/aida-historia-completa-post-owners-2026-08-19.md` — **la historia completa de AIDA**: complementa la presentacion a owners (armada antes de cerrar el dx) con lo que respondio la owner y con el diagnostico terminado. ⭐ Aporta el hallazgo que cierra la paradoja de adopcion —**el uso esta en los objetivos de valoracion del asesor**— y separa los seis arreglos en dos rutas: cuatro de contenido sin presupuesto, dos de producto con solicitud del negocio | `aida-copiloto-asesor-rimac` | 2026-08-19 | al dia |
| `_outputs/aida-objetivo-vs-diagnostico-2026-08-12.md` — **contraste entre el objetivo con que se creó AIDA** (reducir tiempo de gestión, mejorar conversión indirectamente) **y el diagnóstico a la fecha**. Veredicto: ninguno de los dos objetivos es afirmable —falta línea base y el ciclo de venta excede el piloto— y AIDA funciona bien pero **para algo distinto de lo que se le pidió** (estudio de producto, no productividad comercial). Cierra con 6 acciones ordenadas por valor/esfuerzo | `aida-copiloto-asesor-rimac` | 2026-08-12 | al día |
| `_outputs/anexo-playbook-fichas-producto-vida-2026-08-12.md` — **anexo del Playbook del Asesor**: fichas de Vida Contigo, VAG, Temporal Total y Vida Flexible construidas desde `Matriz_productos_VIDA_FINAL.xlsx` con **solo los 29 parámetros que tienen dato completo en los cuatro productos** (0 campos faltantes). Incluye reglas de posicionamiento y la lista de los 41 parámetros excluidos como agenda para Producto | `matriz-productos-vida-rimac`, `proyecto-back-to-basics-ffvv-vida` | 2026-08-12 | al día |
| `_outputs/zoom-c4-contenido-clinico-2026-08-12.md` — anexo del brief: qué significa exactamente «nada generado sobre el cuerpo», qué dice cada fuente y qué no dice, y **mapa de 6 casos documentados** de respuestas generativas en temas clínicos (Tessa/NEDA, bromismo, Raine, Garcia, Babylon, Ada Health) | `capacidades-asistente-ia-aseguradora` | 2026-08-12 | al día |
| `_outputs/brief-arquitectura-agente-2026-08-12.html` + `Brief-arquitectura-agente-IA.pdf` — **brief para Arquitectura de Capacidad (CIA)**: 29 recomendaciones en 9 capas, sin duplicados, cada una marcada según venga de la evaluación del asesor web (5), de la literatura (15) o de ambas (9) | `capacidades-asistente-ia-aseguradora` | 2026-08-12 | al día |
| `_outputs/como-trabajan-equipos-diseno-referencias-2026-08-10.md` — complemento del anterior: cómo trabajan equipos de diseño con los roles Product/Service/Behavioral Designer + UX Researcher. Modos organizativos, benchmarks de composición, y **corpus peruano** (CIX BCP, MineduLAB, BE OEFA, La Victoria Lab/LaBentana, CoE RIMAC). Fuentes F-483 a F-500 | `tendencias-diseno-innovacion`, `metodologias-diseno-sistemas-complejos`, `behavioral-design-estado-disciplina` | 2026-08-10 | al día |
