...
| `research/_outputs/aida-banco-preguntas-corrida.md` | **Hoja de corrida** del banco de preguntas de AIDA — solo la lista ejecutable (v1.1) | ⭐⭐ **Tanda 0: 24 preguntas reales del log**, se pegan con sus faltas · controles de producto reducidos a 4 · reglas de captura (respuesta literal **con las citas**, dos tiempos, sesión, y qué tuvo que hacer después) · **núcleo mínimo de 12** · ⭐ la tanda de consistencia se acortó a 5 corridas y **ya no exige 4 días** |
