...
| `research/_nodes/tratamiento-tlp-borderline.md` | Tratamiento del TLP (trastorno límite de la personalidad): qué se sabe sobre "curarlo" | `/trinidad` 2026-09-10. Remisión 85-99% pero recuperación funcional <50%; **ninguna psicoterapia es superior a otra** (DBT≈GPM, especializado≈generalista); sin fármaco aprobado; CIE-11 dimensional; estigma iatrogénico. Fuentes F-469 a F-499. ⚠️ Sin datos de Perú/LatAm — no extrapolar |
