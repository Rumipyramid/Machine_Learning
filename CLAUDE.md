...
| `research/_outputs/aida-diagnostico-cuatro-frentes.md` | ⭐⭐ **Marco del diagnóstico en 4 frentes** + **frente del cliente entregado** | Owners · asesores · **cliente** · auditoría, cada uno con su límite declarado · ⭐⭐⭐ **AIDA responde lo declarativo y falla lo deliberativo** (explicar/comparar/objetar tienen 2-2,6× más calificaciones negativas que la base) · **objeciones: 42% de lo que piden, 1,1% de lo que preguntan** · 3 problemáticas del cliente sin mapear antes (flexibilidad, comparación contra AFP/banco, miedo al mercado) |
| `research/_outputs/aida-analisis-logs-2026-08-20.md` | ⭐⭐⭐ **Análisis de los logs reales de AIDA** — 2.697 consultas, 274 asesores | ⚠️ **El archivo cubre 2 días, no los 3 meses declarados** · **68,2% de preguntas repetidas no recuperan siempre las mismas fuentes** (75,9% en Vida) · **4 documentos bajo el código de Vida Flexible, uno de otro producto** · el código 999992 confirma que **Vida Contigo = VAG** (el Playbook está mal) · contaminación cruzada de ramos · las negativas tienen 2,1× más falta de cita y 6,3× más «no tengo esa información» · ⚠️ una cuenta de servicio con 651 consultas **puede estar inflando el dashboard** · ⭐⭐ **§2.8: ya existe una batería de prueba corriendo contra AIDA** (10 ítems de brochures y speeches de un solo usuario + serie de QA de 18) — pedirla antes de correr el banco G · ✅ la inestabilidad **aguanta** quitarle esa batería: **61,8% general, 69,6% en Vida**, que es la cifra a usar · ⭐⭐⭐ **§2.9: primera medición contra el objetivo** — **AIDA es más larga justo donde el asesor tiene menos tiempo** (485 palabras en objeción vs. 205 del corpus) y **solo 1 de cada 4 consultas se resuelve en un turno** |
| `research/_outputs/aida-kit-campo-asesores.md` | **Kit de campo** para capturar la conducta del asesor (con AIDA y con IA de afuera) | Textos listos para enviar · ⭐ prioriza logs y **captura en el momento** sobre entrevista retrospectiva · bitácora diaria por WhatsApp con **pedido de capturas de pantalla** · 4 entrevistas con muestreo deliberado · **shadowing deferido** · gestión de la deuda de credibilidad con los asesores |
| `research/_outputs/aida-banco-preguntas-corrida.md` | ⭐ **Guía de corrida de AIDA: qué pegar y qué anotar** (v3.0) — documento de campo, sin metodología | ⭐⭐ **Ordenada por el objetivo declarado** (reducir tiempo operativo en la venta → conversión), no solo por el dolor del asesor: cada bloque marcado por **momento de uso** 🔴🟡🟢 · ⛔ **Bloque 0 = línea base sin AIDA, va antes que todo** o el cronómetro queda contaminado · **7 tareas del que corre**, incluidas **minutos totales hasta respuesta usable** y **¿usable tal cual con el cliente?** · 8 bloques · núcleo de 12 · ⭐ tabla de **qué eslabón hacia conversión mide y cuál no** · anexo con las 58 preguntas seguidas |
| `research/_outputs/protocolo-interrogacion-aida-vida.md` | ⭐ **Instrumento vigente para medir la calidad técnica y de respuestas de AIDA** (**v1.2, dos partes**) | **Parte I:** A auto-interrogación · B calidad contra la matriz · C ruteo · D Claude como auditor. **Parte II:** ⭐ **F calidad contra el objetivo declarado** (consolidar información · reducir tiempos) · **G las tres funcionalidades** (speeches/cuadros/brochures) · **H consistencia** · ⭐⭐ **I eficiencia técnica** (12 ítems + cronometraje + línea base sin AIDA) · **juez Claude Opus 5** con calibración κ≥0,60 obligatoria + ⭐ **paso previo determinista** que no se le delega. ⭐ **El objetivo primario de AIDA nunca se midió: ningún indicador del dashboard es tiempo.** ⭐⭐ **v1.1:** el banco B deja de ser provisional — lo reemplaza el **banco R de 24 preguntas reales del log**, apuntado a explicar/comparar/objetar; entra la dimensión **D7 · Coherencia interna**; el banco H **ya está medido** y solo queda la prueba de distinta formulación. ⭐⭐ **v1.2: el objetivo pasa a criterio primario** — O3/O4 con dato (**485 palabras de mediana en objeciones contra 205 del corpus**), la línea base sin AIDA se adelanta a primer lugar, y el tiempo que cuenta es el **total hasta respuesta usable**, no la latencia |
