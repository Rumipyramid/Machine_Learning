...
| `research/_nodes/tendencias-diseno.md` | **Node acumulativo** de tendencias en diseño: impacto tangible demostrado vs. propuesta innovadora | Se enriquece en cada corrida recurrente de `/trinidad`: escala de madurez de evidencia, tablero de hipótesis vivas (confrontar antes que buscar novedad), reglas de criterio destiladas y bitácora de iteraciones. Fuentes F-236 a F-327 |
