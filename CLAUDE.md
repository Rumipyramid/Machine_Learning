...
| `research/_nodes/mecanismos-seguros-salud.md` | Mecanismos de seguros de salud **y eficiencia del gasto** (v2.2, alcance ampliado el 2026-09-02/03 — ver §0 del node) | Singapur 3M, NHS, capitación, Discovery Vitality, Kaiser, Oak Street, ChenMed, MLR/regla 80-20, Optum/PBM… **+ §6** qué reduce el gasto fuera de lo médico (RCT de wellness, hotspotting, comida como medicina, determinantes sociales), **§7** palancas clínicas por magnitud (reference pricing, biosimilares, sitio de atención, bundles, ACOs, hospital en casa, task-shifting, V-BID, GLP-1), **§8** matriz rentabilidad × salud (Narayana, Aravind, MedPAC/MA, Hapvida, Ping An), **§9** seis reglas incl. *bolsillo equivocado*, **§10** cuidado integral + modelo de Porter/VBHC + autoatención digital (Kinzigtal, Nuka, Alzira, Karolinska, Martini-Klinik, PHTI, TASMINH4, redes limitadas, autorización previa) y reglas 7-9, **§11** glosario operativo (cada estrategia con impacto en salud × impacto en negocio × nivel de evidencia). F-469 a F-521 |
