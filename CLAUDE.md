...
| `research/_fuentes_internas/Playbook_del_Asesor.md` | **Playbook del Asesor** — el modelo de venta Vida, fuente canónica declarada (100.173 car., 5 bloques) | Documento interno RIMAC subido 2026-08-14; evaluado en `diagnostico-copiloto-ai-asesor-vida-rimac` §14 — ⚠️ contiene contradicciones de catálogo y 8 secciones pendientes |
| `research/_nodes/diagnostico-copiloto-ai-asesor-vida-rimac.md` | **Diagnóstico de AIDA**, el copiloto del asesor de Vida (RIMAC) — proyecto asociado a Back to Basics (abierto 2026-08-14) | Brief ordenado en 4 frentes · taxonomía de 3 capas de falla (conocimiento/instrucciones/plataforma) + la prueba que las separa · qué debe hacer el asesor con respaldo verificado (F-476 a F-478) · mapa de **6 frentes** del asesor y **3 agentes de IA desplegados** (AIDA, suscripción, Sales Coach) → reancla el diagnóstico a **Dx2** · §8 arquitectura: consolidar la interfaz sí, las bases de conocimiento no · §9 **el copiloto no puede resolver la contradicción aguas arriba, solo ocultarla** — la inconsistencia de AIDA puede ser la de la organización reflejada · §10 **barrera de actualización de producto** (piso regulatorio SBS vs. capa comercial acelerable; la matriz debe ser fuente, no destino) · §11 **auto-interrogación**: AIDA es multi-ramo (5 subagentes, 1 de Vida), el ruteo ya existe, y ⚠️ **`transfer_to_agent` apunta a Google ADK, no a Copilot** — límites técnicos en suspenso hasta confirmar · §16 **Release 1 en 3 etapas** (diagnóstico · intervención · testeo) · ⚠️ **AIDA (Microsoft Copilot, ya desplegada) y el prototipo del Plan Piloto (Claude) son dos herramientas distintas** — no confundirlas, el repo lo hizo hasta el 2026-08-14 |
| `research/_outputs/release-1-base-conocimiento-aida.md` · `release-1-aida-presentable-2026-08-14.html` | **Release 1 de las intervenciones en AIDA** (v2.0) — versión extendida (fuente de verdad) + versión presentable publicada como artifact | **Tres etapas: diagnóstico → intervención → testeo.** 5 entregables con el catálogo como bloqueante · inventario como entregable cero · serie temporal interrumpida con los otros ramos como control natural · el riesgo de adopción que puede anularlo |
...
| `research/_nodes/arquitectura-conocimiento-agentes-copilot.md` | Cómo almacenar información para que un agente de Copilot la consuma bien | Matriz de formatos · 3 techos (licencia 7 MB vs. 200 MB, 36.000 caracteres/archivo, ≤300 págs.) · 7 reglas de redacción (**sin tablas**, encabezados, un tema por documento) · gobierno/ROT · protocolo de auditoría · **uno vs. varios agentes** (fuentes no superpuestas por dominio; consolidar bases sube la alucinación). Fuentes F-469 a F-475, F-479, F-480 |
