...
| `research/_nodes/tendencias-diseno.md` | **Node acumulativo** de tendencias en diseño: impacto tangible demostrado vs. propuesta innovadora | Se enriquece en cada corrida recurrente de `/trinidad`: escala de madurez de evidencia, tablero de hipótesis vivas (confrontar antes que buscar novedad), reglas de criterio destiladas y bitácora de iteraciones. **v2.0 (iter. 2, 2026-07-29)**: 22 hipótesis, 18 reglas. Fuentes F-237 a F-328 y F-380 a F-398 |
