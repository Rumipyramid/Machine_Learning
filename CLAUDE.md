...
| `research/_nodes/diagnostico-copiloto-ai-asesor-vida-rimac.md` | **Diagnóstico del Copiloto AI del asesor de Vida (RIMAC)** — proyecto asociado a Back to Basics (abierto 2026-08-14) | Brief ordenado en 4 frentes · taxonomía de 3 capas de falla (conocimiento/instrucciones/plataforma) + la prueba que las separa · qué debe hacer el asesor con respaldo verificado (F-476 a F-478) · 5 preguntas abiertas, incluida la ambigüedad de plataforma AIDA-Claude vs. Copilot |
