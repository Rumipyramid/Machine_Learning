...
| `research/_outputs/aida-banco-preguntas-corrida.md` | **Hoja de corrida** del banco de preguntas de AIDA — solo la lista ejecutable | 8 tandas, ~45 ítems · reglas de captura (respuesta literal **con las citas**, segundos, sesión, y qué tuvo que hacer después) · **núcleo mínimo de 12** si el tiempo aprieta · la tanda de consistencia necesita ≥4 días |
| `research/_outputs/protocolo-interrogacion-aida-vida.md` | Instrumento ejecutable de diagnóstico de AIDA (**v1.0, dos partes**) | **Parte I:** A auto-interrogación · B calidad contra la matriz · C ruteo · D Claude como auditor. **Parte II:** ⭐ **F calidad contra el objetivo declarado** (consolidar información · reducir tiempos) · **G las tres funcionalidades** (speeches/cuadros/brochures) · **H consistencia** · ⭐⭐ **I eficiencia técnica** (12 ítems + cronometraje + línea base sin AIDA) · **juez Claude Opus 5** con calibración κ≥0,60 obligatoria. ⭐ **El objetivo primario de AIDA nunca se midió: ningún indicador del dashboard es tiempo.** ⚠️ El banco B sigue provisional hasta el campo |
