...
| `research/_nodes/diagnostico-copiloto-ai-asesor-vida-rimac.md` | **Diagnóstico de AIDA**, el copiloto del asesor de Vida (RIMAC) — proyecto asociado a Back to Basics (abierto 2026-08-14) | Brief ordenado en 4 frentes · taxonomía de 3 capas de falla (conocimiento/instrucciones/plataforma) + la prueba que las separa · qué debe hacer el asesor con respaldo verificado (F-476 a F-478) · preguntas abiertas · ⚠️ **AIDA (Microsoft Copilot, ya desplegada) y el prototipo del Plan Piloto (Claude) son dos herramientas distintas** — no confundirlas, el repo lo hizo hasta el 2026-08-14 |
| `research/_nodes/arquitectura-conocimiento-agentes-copilot.md` | Cómo almacenar información para que un agente de Copilot la consuma bien | Matriz de formatos · 3 techos (licencia 7 MB vs. 200 MB, 36.000 caracteres/archivo, ≤300 págs.) · 7 reglas de redacción (**sin tablas**, encabezados, un tema por documento) · gobierno/ROT · protocolo de auditoría. Fuentes F-469 a F-475 |
