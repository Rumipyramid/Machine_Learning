...
| `research/_nodes/tendencias-diseno-innovacion.md` | **Node acumulativo** de tendencias en **diseño e innovación**: impacto tangible demostrado vs. propuesta sin respaldo | ⚠️ **Alcance ampliado el 2026-08-02** de "diseño" a "diseño e innovación" (§0 del node manda sobre el prompt de la rutina, que todavía dice solo "diseño"); el node se renombró de `tendencias-diseno.md`. Se enriquece en cada corrida recurrente de `/trinidad`: escala de madurez de evidencia, tablero de hipótesis vivas (confrontar antes que buscar novedad), reglas de criterio destiladas y bitácora de iteraciones. **v3.0 (iter. 3, 2026-08-02)**: 26 hipótesis, 21 reglas. Fuentes F-237 a F-328, F-380 a F-398 y F-399 a F-429 |
