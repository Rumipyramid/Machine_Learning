...
| `research/_nodes/tendencias-diseno.md` | **Node acumulativo** de tendencias en diseño: impacto tangible demostrado vs. propuesta innovadora | Se enriquece en cada corrida recurrente de `/trinidad`: escala de madurez de evidencia, tablero de hipótesis vivas (confrontar antes que buscar novedad), reglas de criterio destiladas, **§1.bis de correcciones a iteraciones previas** y bitácora. Fuentes F-237 a F-391 (iter. 1: F-237-F-328 · iter. 2: F-329-F-391) |
