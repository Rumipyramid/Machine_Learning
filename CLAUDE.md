...
| `research/_nodes/digitalizacion-y-ecosistemas-de-seguros.md` | Digitalización de seguros y ecosistemas: estado del arte (`/seeker`) + **bench 2026** | ⚠️ Marca 4 cifras como **no citables**: el "70% de transformaciones que fracasa" (huérfano de cita), el "<5% ecosystem masters" (artefacto definicional), las proyecciones de *embedded insurance* (1,4x de dispersión para el mismo año) y las cifras de STP de proveedores. Hallazgo central: la digitalización vs. productividad es una **curva en U**. Fuentes F-469 a F-505 |
