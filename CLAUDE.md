...
| `research/_nodes/tendencias-diseno-innovacion.md` | **Node acumulativo** de tendencias en **diseño e innovación**: impacto tangible demostrado vs. propuesta sin respaldo | ⚠️ **Alcance ampliado el 2026-08-02** de "diseño" a "diseño e innovación" (§0 del node manda sobre el prompt de la rutina, que todavía dice solo "diseño"); el node se renombró de `tendencias-diseno.md`. Se enriquece en cada corrida recurrente de `/trinidad`: escala de madurez de evidencia, tablero de hipótesis vivas (confrontar antes que buscar novedad), reglas de criterio destiladas y bitácora de iteraciones. **v5.0 (iter. 5, 2026-08-05)**: 33 hipótesis, 23 reglas. ⭐⭐ Especie nueva de defecto de cita — la **cifra prefabricada** (C23/H32): artículo de "resultados" del Q2 de Figma publicado ~7 h antes del reporte, desmontado por aritmética. 🔄 H29 reformulada (el separador insurtech es el ratio de gastos, no la suscripción). 🪞 Auditoría C20: el RCT de UBI sobrevive pero el node le pidió de más → H24 afinada. ⚠️ F-449 corregida → H33. ⏳ H13/H16 abiertas: Figma reportó tras el cierre de la corrida. 🎨 Diseño: F-237 a F-328, F-380 a F-398, F-399 a F-429 · 💡 Innovación: F-430 a F-468 · iter. 5: F-469 a F-482 |
