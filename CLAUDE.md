...
| `research/_nodes/tendencias-diseno.md` | **Node acumulativo** de tendencias en diseño: impacto tangible demostrado vs. propuesta innovadora | Se enriquece en cada corrida recurrente de `/trinidad`: escala de madurez de evidencia, tablero de hipótesis vivas (confrontar antes que buscar novedad), reglas de criterio destiladas y bitácora de iteraciones. **v3.0 (iter. 3, 2026-08-02)**: 26 hipótesis, 21 reglas. Fuentes F-237 a F-328, F-380 a F-398 y F-399 a F-429 |
