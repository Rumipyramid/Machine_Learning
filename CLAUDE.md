...
| `research/prediccion_renovacion_churn_seguros.md` | Síntesis de predictores de renovación/churn en seguros, desagregada: transversal → ramo → región → Perú → NSE, con tabla maestra e implicaciones de modelado | Distingue churn activo vs. caída involuntaria; fuentes F-35..F-44 |
| `research/propuesta_modelo_churn_peru.md` | Propuesta técnica de modelo de churn/renovación en Perú: dos targets (lapse involuntario vs. baja voluntaria) × ramo, features de alta rigurosidad, método, métricas y roadmap | Desagrega por NSE/perfil solo si prueba de heterogeneidad lo justifica; apoyada en fuentes 🟢A/🔵B |
| `research/features_modelo_churn_peru.md` | Operacionalización de features del modelo de churn: variable · cálculo · fuente de dato · target (A involuntario / B voluntario) · tipo, en 7 grupos | Lista lista para el equipo de data; marca leakage y el flag del structural break |
