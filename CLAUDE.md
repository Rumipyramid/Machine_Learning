...
| `research/_nodes/tendencias-diseno-innovacion.md` | **Node acumulativo** de tendencias en **diseño e innovación**: impacto tangible demostrado vs. propuesta sin respaldo | ⚠️ **Alcance ampliado el 2026-08-02** de "diseño" a "diseño e innovación" (§0 del node manda sobre el prompt de la rutina, que todavía dice solo "diseño"); el node se renombró de `tendencias-diseno.md`. ⚠️ **Filtro de salida obligatorio (2026-08-07):** toda corrida —incluida la programada, cuyo prompt no lo repite— debe pasar por el punto 7 de "Cómo se usa y se enriquece": revisar el **🗺️ Mapa de espacios** antes de decidir qué escribir, **tomar posición** (dejar al menos un juicio en **💎 Juicios vigentes**, con la estructura *qué sostiene · con qué · qué cambia el lunes*), cubrir el **oficio** y no solo la epistemología, y **ordenar para lectura humana**: primero el juicio, después la evidencia, al final el detalle. Si nada de la corrida cambia lo que un diseñador hace el lunes, la iteración está incompleta. Se enriquece en cada corrida recurrente de `/trinidad`: escala de madurez de evidencia, tablero de hipótesis vivas (confrontar antes que buscar novedad), reglas de criterio destiladas y bitácora de iteraciones. **v5.0 (iter. 5, 2026-08-07)**: 34 hipótesis, 24 reglas. ⭐ La iteración 5 cerró **H13**, la primera hipótesis del node resuelta contra una fecha fijada de antemano (Figma Q2), y su auditoría hacia adentro encontró que **verificar que una fuente exista no es verificar que la cita sea fiel** (C23). 🎨 Diseño: F-237 a F-328, F-380 a F-398, F-399 a F-429 · 💡 Innovación: F-430 a F-468 · 🔁 Iter. 5: F-469 a F-477 |
