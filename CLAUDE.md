...
| `reportes/presentacion_back_to_basics.md` · `reportes/assets/ecosistema_venta_vida.jpg` | Presentación del proyecto Back to Basics (FFVV Vida Individual) para Milagros/comité | Origen, contexto, diagnóstico sistémico (3 hallazgos), entregables V1, siguientes pasos, mapa del ecosistema |
| `reportes/presentacion_back_to_basics_lowfi.html` | Versión low-fi (storyboard wireframe) de la presentación anterior | Generada con el skill `/low-fi-slides`; 15 láminas, imagen del mapa embebida tal cual; abrir en navegador |
